...
import { create, patch, remove, watch } from "../utils/fireUtils";
import "../styles/AdminPages.css";

/**
 * MenuPage Component
 * Handles the restaurant menu management.
 * Features include adding/editing dishes, setting availability, and uploading images via Cloudinary.
 */
export default function MenuPage() {
  ...
  // Watch menu collection for real-time updates
   ...
   * Uses an unsigned upload preset for direct browser uploads
   */
