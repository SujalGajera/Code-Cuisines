...
/**
 * Home Component
 * Landing page for the Code & Cuisine application.
 * Features a hero section, feature highlights, menu preview, and testimonials.
 */
function Home() {
  ...
  // Sample menu items for the quick preview modal
  const previewItems = [
    {
      id: 1,
      name: 'Smoked Salmon Benedict',
      description: 'Toasted sourdough, poached eggs, smoked salmon and house hollandaise.',
      price: 'NZ$18.50',
    ...
    },
    {
      ...
      description: 'Fresh fettuccine tossed in a rich parmesan cream with garlic and herbs.',
      price: 'NZ$24.00',
    ...
    },
    {
      ...
      description: 'Marinated chicken, roasted veggies and jasmine rice with a citrus dressing.',
      price: 'NZ$25.90',
    ...
    },
    {
      ...
      description: 'Warm chocolate brownie topped with vanilla ice cream and toasted nuts.',
      price: 'NZ$14.50',
