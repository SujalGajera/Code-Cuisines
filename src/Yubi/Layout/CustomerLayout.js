...
const navItems = [
  ...
  { id: "reservations", label: "Reservations", icon: <FaCalendarAlt />, path: "/customer/reservations" },
  { id: "menu", label: "Menu", icon: <FaUtensils />, path: "/customer/menu" },
  { id: "orders", label: "Order History", icon: <FaHistory />, path: "/customer/orders" },
  { id: "feedback", label: "Feedback", icon: <FaCommentDots />, path: "/customer/feedback" },
];
...
function CustomerLayout({ children }) {
  ...
  /* FIX: Removed the unused 'handleCheckout' function here because 
     the Checkout button below navigates directly to /customer/payment.
  */

  // Add user prop to children
      ...
      <header className="cc-topbar">
        <div className="cc-topbar-left">
          ...
          <div className="cc-brand">
            <div className="cc-brand-icon">
              <img src={logo} alt="logo" className="cc-brand-logo" />
            </div>
        ...
        <div className="cc-topbar-right">
          ...
          <div className="cc-user-chip">
            <img src={avatarImg} className="cc-user-avatar" alt="avatar" />
